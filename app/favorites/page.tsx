          ...
          <div className="max-w-6xl mx-auto space-y-4 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-neutral-600 font-mono bg-[#F9F9F8] px-4 py-2 rounded-full border border-neutral-200 shadow-2xs">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 pt-8">
          {favorites.length === 0 ? (
            ...
            <div className="bg-white rounded-3xl p-12 md:p-16 text-center space-y-6 border border-neutral-200/80 shadow-2xs max-w-lg mx-auto my-12 font-sans">
              <div className="w-16 h-16 rounded-full bg-[#F9F9F8] flex items-center justify-center mx-auto text-neutral-400 border border-neutral-200">
